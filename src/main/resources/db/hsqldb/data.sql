...
INSERT INTO rooms(id, name, card_image, room_type, treasure, damage, passive_trigger, effect, effect_target) VALUES
    ...
    (1, 'Bottomless Pit',      '/resources/images/rooms/room_00.jpg', 'TRAP', '0001', 1, 'DESTROY_THIS_ROOM','KILL_ONE_HERO_IN_THIS_ROOM','ENUMERADO'),
    (2, 'The Crushinator',     '/resources/images/rooms/room_01.jpg', 'ADVANCED_TRAP', '0001', 2, 'DESTROY_ANOTHER_ROOM','ADD_2_DAMAGE_TO_EVERY_ROOM','ENUMERADO'),
    (3, 'Vampire Bordello',    '/resources/images/rooms/room_02.jpg', 'ADVANCED_MONSTER', '0010', 3, 'HERO_DIES_IN_THIS_ROOM','CONVERT_A_WOUND_INTO_A_SOUL','ENUMERADO'),
    (4, 'Monster Ballroom',    '/resources/images/rooms/room_03.jpg', 'ADVANCED_MONSTER', '0100', 0, 'NONE','NOTHING','ENUMERADO'),
    (5, 'Boulder Ramp',        '/resources/images/rooms/room_04.jpg', 'TRAP', '0001', 1, 'DESTROY_ANOTHER_ROOM','DEAL_5_DAMAGE_TO_A_HERO_IN_THIS_ROOM','ENUMERADO'),
    (6, 'Construction Zone',   '/resources/images/rooms/room_05.jpg', 'TRAP', '0101', 1, 'BUILD_THIS_ROOM','BUILD_ANOTHER_ROOM','ENUMERADO'),
    (7, 'Dark Altar',          '/resources/images/rooms/room_06.jpg', 'TRAP', '0020', 1, 'DESTROY_THIS_ROOM','CHOOSE_CARD_FROM_DISCARD_PILE','ENUMERADO'),
    (8, 'Dragon Hatchery',     '/resources/images/rooms/room_07.jpg', 'MONSTER', '1111', 0, 'NONE','NOTHING','ENUMERADO'),
    (9, 'Neanderthal Cave',    '/resources/images/rooms/room_08.jpg', 'MONSTER', '0100', 3, 'NONE','NOTHING','ENUMERADO'),
    (10, 'Open Grave',         '/resources/images/rooms/room_09.jpg', 'TRAP', '0010', 2, 'HERO_DIES_IN_THIS_ROOM','CHOOSE_ROOM_CARD_FROM_DISCARD_PILE','ENUMERADO'),
    (11, 'Recycling Center',   '/resources/images/rooms/room_10.jpg', 'ADVANCED_TRAP', '0001', 3, 'DESTROY_ANOTHER_ROOM','DRAW_2_ROOM_CARDS','ENUMERADO'),
    (12, 'Ligers Den',         '/resources/images/rooms/room_11.jpg', 'ADVANCED_MONSTER', '1000', 2, 'USE_SPELL_CARD','DRAW_A_SPELL_CARD','ENUMERADO'),
    (13, 'Goblin Armory',      '/resources/images/rooms/room_12.jpg', 'MONSTER', '0200', 1, 'NONE','ADD_1_DAMAGE_TO_ADYACENT_MONSTER_ROOMS','ENUMERADO'),
    (14, 'Golem Factory',      '/resources/images/rooms/room_13.jpg', 'MONSTER', '0100', 2, 'HERO_DIES_IN_THIS_ROOM','DRAW_A_ROOM_CARD','ENUMERADO'),
    (15, 'Jackpot Stash',      '/resources/images/rooms/room_14.jpg', 'TRAP', '0002', 1, 'DESTROY_THIS_ROOM','DOUBLE_DUNGEON_TREASURE_VALUE','ENUMERADO'),
    (16, 'Dark Laboratory',    '/resources/images/rooms/room_15.jpg', 'TRAP', '2000', 1, 'BUILD_THIS_ROOM','DRAW_2_SPELL_CARDS_AND_DISCARD_1_SPELL_CARD','ENUMERADO'),
    (17, 'Monstrous Monument', '/resources/images/rooms/room_16.jpg', 'TRAP', '0110', 1, 'BUILD_THIS_ROOM','CHOOSE_MONSTER_ROOM_CARD_FROM_DISCARD_PILE','ENUMERADO'),
    (18, 'Beast Menagerie',    '/resources/images/rooms/room_17.jpg', 'ADVANCED_MONSTER', '0100', 4, 'BUILD_MONSTER_ROOM','DRAW_A_ROOM_CARD','ENUMERADO'),
    (19, 'Brainsucker Hive',   '/resources/images/rooms/room_18.png', 'MONSTER', '1000', 2, 'HERO_DIES_IN_THIS_ROOM','DRAW_A_SPELL_CARD','ENUMERADO'),
    (20, 'Dizzygas Hallway',   '/resources/images/rooms/room_19.png', 'TRAP', '0001', 1, 'NONE','ADD_2_DAMAGE_TO_NEXT_ROOM_IF_IT_IS_A_TRAP_ROOM','ENUMERADO'),
    (21, 'Minotaurs Maze',     '/resources/images/rooms/room_20.png', 'MONSTER', '0100', 0, 'NONE','PUSH_HERO_TO_PREVIOUS_ROOM_ONCE','ENUMERADO');

INSERT INTO spell_card(id, name, card_image, phase, target, effect, requirements) VALUES
    (22,'Giant Size'       ,'/resources/images/spells/spell_00.jpg','adventurePhase'               ,'MONSTERROOM'  ,'ADD_3_DAMAGE_TO_A_CHOSEN_MONSTER_ROOM','HAVEMONSTERROOM')      ,
    (23,'Soul Harvest'     ,'/resources/images/spells/spell_01.jpg','adventureAndConstructionPhase','HEROINSCORE'  ,'TRADE_A_SOUL_FOR_2_SPELL_CARDS','HAVESOULS')            ,
    (24,'Princess in Peril','/resources/images/spells/spell_02.jpg','constructionPhase'            ,'HEROINTOWN'   ,'LURE_A_CHOSEN_HERO_FROM_CITY_TO_DUNGEON','THEREISHEROINTOWN')    ,
    (25,'Motivation'       ,'/resources/images/spells/spell_03.jpg','constructionPhase'            ,'ALLPLAYERS'   ,'BUILD_ANOTHER_ROOM_IF_ANOTHER_PLAYER_HAS_MORE_ROOMS','NONE')                 ,
    (26,'Exhaustion'       ,'/resources/images/spells/spell_04.jpg','adventurePhase'               ,'HEROINDUNGEON','DEAL_ROOM_AMOUNT_DAMAGE_TO_HERO','THEREISHEROINDUNGEON') ,
