...
<head>
    ...
    <title>Boss Monster :: A DP Project made with love</title>

    <%-- CSS generated from LESS --%>
    <spring:url value="/resources/css/bossmonster.css" var="bossmonsterCss"/>
    <link href="${bossmonsterCss}" rel="stylesheet"/>
